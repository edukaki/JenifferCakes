...
export default function Quotes(props) {
  return (
    <div className="flex flex-col items-center text-xl w-11/12">
      <span className="text-7xl -mb-9 text-left w-full">“</span>
      <p className={`px-4 ${props.secondParagraph && 'pb-8'}`}>
        {props.firstParagraph}
      </p>
      {props.secondParagraph && <p className="px-4">{props.secondParagraph}</p>}
